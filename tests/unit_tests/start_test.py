...
parser.add_argument('--file_in_invalid_format', help='File in not supported format', default=default_file_in_invalid_format)
parser.add_argument('--big_file', help='File larger than 10 Mb', default=default_big_file)
parser.add_argument('--max_long_calc', help='How many long calculations is allowed to user', default=default_max_long_calc)
